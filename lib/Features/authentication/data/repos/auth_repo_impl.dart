...
class AuthRepoImpl extends AuthRepo{
  ...
  @override
  Future<Either<Failure, AuthEntity>> userLogin(SignInParameters parameters)async{
    try {
  ...
  @override
  Future<Either<Failure, AuthEntity>> userRegister(SignUpParameters parameters)async{
    try {
