...
class HomeRepoImpl extends HomeRepo{
  ...
  @override
  Future<Either<Failure, ProductDetailsEntity>> getProductDetails(ProductDetailsParameters parameters)async{
    try {
      final result = await homeBaseRemoteDataSource.getProductDetails(parameters);
      return right(result);
    } on ServerException catch (failure) {
      return Left(ServerFailure(failure.errorMessageModel.message));
    }
